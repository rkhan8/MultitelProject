...
* Improved debugging mode (see [test/bench.js](/webService/test/bench.js))
* Added `make bench` for a one-pass benchmark.

0.3.3 / 2012-05-27
==================

* Fixed tests, [package.json](/webService/package.jsonackage.json) for development, and regex
...
* Updated repository location and author information in [package.json](/webService/package.jsonackage.json).
