...
describe("Persistence Service Integration Test", function() {
    describe("store Signal Information", function() {
        it("Should call signal repository insertNewSignal function with correct arguments", sinon.test(function() {
    ...
    describe("save Signal Value",  function() {
        it("Should call signal repository insertSignalValue function with correct arguments", sinon.test(function () {
    ...
    describe("get Recording Dates", function() {
        it("Should call signal repository getRecordingDates function", sinon.test(function() {
    ...
    describe("get Signals Id", function() {
        it("Should call signal repository getSignalsId function", sinon.test(function() {
    ...
    describe("get Signals Unity", function() {
        it("Should call signal repository getSignalsUnity function", sinon.test(function() {
    ...
    describe("get Signals Categories", function() {
        it("Should call signal repository getSignalsCategories function", sinon.test(function() {
    ...
    describe("get Signals Values", function() {
        it("Should call signal repository getSignalsValues function with correct arguments", sinon.test(function() {
    ...
    describe("get Signals", function() {
        it("Should call signal repository getSignals function with correct arguments", sinon.test(function() {
    ...
    describe("get Not Displayed SignalsId", function() {
        it("Should call signal repository getNotDisplayedSignalsId function", sinon.test(function() {
    ...
    describe("remove Signal From Display", function() {
        it("Should call signal repository updateSignalStatus function with correct arguments", sinon.test(function() {
    ...
    describe("get Signal Infos", function() {
        it("Should call signal repository getSignalInformations function with the same argument", sinon.test(function() {
    ...
    describe("ajouter Batiment", function() {
        it("Should call building repository ajouterBatiment function with the same arguments", sinon.test(function() {
    ...
    describe("get firms", function() {
        it("Should call building repository getCompagnies", sinon.test(function() {
    ...
    describe("get firm's Building name", function() {
        it("Should call building repository getCompagnieBatimentsName with the same argument", sinon.test(function() {
    ...
    describe("get Batiments Information", function() {
        it("Should call building repository getBatimentsInformations with the same arguments", sinon.test(function() {
    ...
    describe("make Signal Displayable", function() {
        it("Should call signal repository and building repository functions with the specific arguments", sinon.test(function() {
            var updateSignalStatusSpy = this.spy(signalRepository, 'updateSignalStatus');
    ...
    describe("get Building Signals Information", function() {
        it("Should call building repository getBatimentSignals function with the same arguments", sinon.test(function() {
    ...
    describe("update Building Information", function() {
        it("Should call building repository updateBatimentInformations function with the same arguments", sinon.test(function() {
    ...
    describe("delete Building", function() {
        it("Should call building repository deleteBatiment function with the same argument", sinon.test(function() {
